...
//getProfile and getQuickProd are going to be used often enough to justify putting them into the myControl.calls
	...
	//				myControl.util.dump('BEGIN myControl.calls.canIHaveSession');
			...
			ping : {
				...
				dispatch : function(tagObj)	{
					myControl.model.addDispatchToQ({"_cmd":"ping","_tag":tagObj}); //get new session id.
					}
				},//ping
...
//					myControl.util.dump(" -> assigned a data-pid attr: "+eleID.pid);
					r.attr('data-pid',eleID.pid); //this has a makesafe on it, but I think that's wrong. I think we want the unmolested sku. changed 2012-01-24
					}
				if(eleID.catsafeid)	{
//					myControl.util.dump(" -> assigned a data-pid attr: "+eleID.pid);
					r.attr('data-catsafeid',eleID.catsafeid); 
					}
